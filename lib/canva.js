    ...
    if (dwshare) {
        dwshare.addEventListener('click', () => {
            if ('share' in navigator) {
                navigator
                    .share({
                        title: `${word} Sending you the Happy தீபாவளி Greeting Wishes in Tamil`,
                        text: `அனைத்து விதமான இன்பங்களும் உங்கள் குடும்பத்திற்கு வந்தடைய இனிய தீபாவளி நல்வாழ்த்துக்கள் - ${word} - Diwali Wishes in Tamil.`,
                        url: `https://wishes.tamilwords.net/?name=${user}`
                    })
                    .then(() => {
