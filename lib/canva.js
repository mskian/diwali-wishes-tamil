...
document.title = `${word} Sending you the Happy Diwali Greeting Wishes in Tamil`;

document.querySelectorAll('meta[property=og\\:title]')[0].setAttribute('content', `${word} Sending you the Happy Diwali Greeting Wishes in Tamil`);
document.querySelectorAll('meta[property=og\\:description]')[0].setAttribute('content', `அனைத்து விதமான இன்பங்களும் உங்கள் குடும்பத்திற்கு வந்தடைய இனிய தீபாவளி நல்வாழ்த்துக்கள் - ${word} Diwali Wishes in Tamil.`);
document.querySelectorAll('meta[property=og\\:image]')[0].setAttribute('content', `https://img.sanweb.info/dt/dt?name=${pageCatch}`);
...
gtag('config', 'G-16C4S2MMTJ', {
    page_title: `${word} Sending you the Happy Diwali Greeting Wishes in Tamil`,
